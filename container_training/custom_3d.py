...
from ..structures.bbox_3d import get_box_type
...
class Custom3DDataset(Dataset):
    ...
    def load_annotations(self, ann_file):
        ...
        return mmengine.fileio.load(ann_file)
    ...
    def pre_pipeline(self, results):
        ...
        results['lidar_points'] = {'lidar_path': results['pts_filename']}
    ...
    def prepare_train_data(self, index):
        ...
        if self.filter_empty_gt and \
                (example is None or 'gt_labels_3' not in example or
