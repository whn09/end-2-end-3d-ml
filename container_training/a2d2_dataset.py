...
from mmdet3d.structures.bbox_3d import (Box3DMode, CameraInstance3DBoxes, Coord3DMode, LiDARInstance3DBoxes, points_cam2img)
...
class A2D2Dataset(Custom3DDataset):  # Custom3DDataset, Det3DDataset
    r"""A2D2 Dataset.
    ...
    def get_data_info(self, index):
        ...
        img_filename = os.path.join(self.data_root,
                                    info['image']['image_path'])  # self.prefix + 
